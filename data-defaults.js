...
const seed={
 settings:{theme:'light',accent:'blue',fab:false,haptics:true,selectedAccountId:'',txFilter:'all',compositionGroup:'',compositionFocus:'',dividendCompositionFocus:'',dividendPeriod:'month',dividendKey:'',policyTab:'isa',pensionGoalExpanded:false,pensionAssetScope:'all',pensionAssetLens:'assetClass',pensionAssetFocus:'',integratedMonth:'',integratedLedgerFilter:'all'},
 policies:{
