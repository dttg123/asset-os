...
const seed={
 settings:{theme:'light',accent:'blue',fab:false,haptics:true,selectedAccountId:'',txFilter:'all',compositionGroup:'',compositionFocus:'',dividendCompositionFocus:'',dividendPeriod:'month',dividendKey:'',policyTab:'isa',pensionGoalExpanded:false,pensionAssetScope:'all',pensionAssetLens:'assetClass',pensionAssetFocus:'',integratedMonth:'',integratedLedgerFilter:'all',monthlyLivingBudget:0,backupV04:{phoneEnabled:false,lastPhoneBackupAt:'',lastReleaseVersion:'',phonePermission:'unknown'}},
 policies:{
