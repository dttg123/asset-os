...
const context={
  ...
  pensionIncomeRecords:()=>[{date:'2026-09-17',type:'distribution',incomeCategory:'dividend',incomeType:'distribution',amount:8500,grossAmount:10000,tax:1500,label:'테스트 ETF',source:'kis-right',readOnly:true,rightTypeCode:'32',productCode:'ETF001'}],
...
assert.deepEqual(JSON.parse(JSON.stringify(payload.pensionSavings.income[0])),{date:'2026-09-17',category:'dividend',type:'distribution',amount:8500,grossAmount:10000,tax:1500,label:'테스트 ETF',source:'kis-right',readOnly:true,rightTypeCode:'32',productCode:'ETF001'});
