...
const context={
  ...
  pensionIncomeRecords:()=>[{date:'2026-09-17',type:'distribution',incomeCategory:'dividend',incomeType:'distribution',amount:8500,grossAmount:10000,tax:1500,label:'테스트 ETF',source:'kis-right',readOnly:true,rightTypeCode:'32',rightTypeName:'분배금',classificationBasis:'event-description',productCode:'ETF001'}],
  brokerKisIncomeCategory:type=>['dividend','distribution'].includes(type)?'dividend':type==='interest'?'interest':'other',
...
assert.deepEqual(JSON.parse(JSON.stringify(payload.pensionSavings.income[0])),{date:'2026-09-17',category:'dividend',type:'distribution',amount:8500,grossAmount:10000,tax:1500,label:'테스트 ETF',source:'kis-right',readOnly:true,rightTypeCode:'32',rightTypeName:'분배금',classificationBasis:'event-description',productCode:'ETF001'});
