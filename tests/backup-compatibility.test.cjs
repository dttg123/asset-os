...
for(let schema=4;schema<=20;schema++){
 context.__payload={format:'asset-os-backup-v1',schemaVersion:schema,appVersion:schema===4?'v0.1':'v0.6.0',environment:'live',exportedAt:'2026-09-02T00:00:00.000Z',data:legacyData()};
...
context.__payload={format:'asset-os-backup-v1',schemaVersion:20,appVersion:'v0.6.0',environment:'qa',data:{accounts:[],pension:{},integrated:{ledger:[]}}};
