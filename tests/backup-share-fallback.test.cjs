...
const context=vm.createContext({
 ...
 APP_VERSION:'v0.6.11',APP_ENV:'qa',SCHEMA_VERSION:20,state:{},
 clone:value=>value,localYmd:()=>'2060-12-31',assetManagedBackupName:()=> 'AssetOS_QA_601231_v0.6.11.zip',
...
(async()=>{
 ...
 assert.equal(downloaded,'AssetOS_QA_601231_v0.6.11.zip');
 assert.equal(sharedFile.name,'AssetOS_QA_601231_v0.6.11.txt');
