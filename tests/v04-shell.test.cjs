...
assert.match(html,/pension-forms\.js\?v=0\.4\.9/);
...
assert.match(html,/isa-summary\.js\?v=0\.4\.13/);
assert.match(html,/pension-pages\.js\?v=0\.4\.10/);
...
assert.match(html,/pwa\.js\?v=0\.4\.11/);
