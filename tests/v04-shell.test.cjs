...
assert.match(html,/pwa\.js\?v=0\.4\.19/);
...
assert.match(html,/ai-strategy\.js\?v=0\.4\.19/);
assert.match(pensionPages,/scope==='all'\?'<button class="ai-strategy-entry"/);
