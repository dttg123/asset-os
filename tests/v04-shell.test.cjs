...
const home=fs.readFileSync(path.join(root,'home.js'),'utf8'),pensionPages=fs.readFileSync(path.join(root,'pension-pages.js'),'utf8'),integratedPages=fs.readFileSync(path.join(root,'integrated-pages.js'),'utf8'),sharedCss=fs.readFileSync(path.join(root,'css-shared-common.css'),'utf8');
...
assert.match(html,/pension-assets\.js\?v=0\.4\.9/);
assert.match(html,/pension-forms\.js\?v=0\.4\.16/);
...
assert.match(html,/isa-summary\.js\?v=0\.4\.21/);
assert.match(html,/pension-pages\.js\?v=0\.4\.21/);
assert.match(html,/integrated-pages\.js\?v=0\.4\.12/);
...
assert.match(html,/pwa\.js\?v=0\.4\.21/);
assert.match(html,/initial-import\.js\?v=0\.4\.9/);
assert.match(html,/chart-asset-analysis\.js\?v=0\.4\.17/);
assert.match(html,/ui-settings\.js\?v=0\.4\.21/);
assert.match(html,/home\.js\?v=0\.4\.18/);
...
assert.match(html,/ai-strategy\.js\?v=0\.4\.20/);
