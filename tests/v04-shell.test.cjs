...
const home=fs.readFileSync(path.join(root,'home.js'),'utf8'),isaSummary=fs.readFileSync(path.join(root,'isa-summary.js'),'utf8'),pensionPages=fs.readFileSync(path.join(root,'pension-pages.js'),'utf8'),integratedPages=fs.readFileSync(path.join(root,'integrated-pages.js'),'utf8'),sharedCss=fs.readFileSync(path.join(root,'css-shared-common.css'),'utf8');
...
assert.match(html,/pension-forms\.js\?v=0\.4\.27/);
...
assert.match(html,/pwa\.js\?v=0\.4\.28/);
