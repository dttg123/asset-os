...
assert.match(html,/pwa\.js\?v=0\.4\.16/);
assert.match(html,/initial-import\.js\?v=0\.4\.9/);
assert.match(html,/chart-asset-analysis\.js\?v=0\.4\.15/);
assert.match(html,/ui-settings\.js\?v=0\.4\.16/);
