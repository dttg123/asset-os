...
assert.match(html,/pension-assets\.js\?v=0\.4\.22/);
assert.match(html,/pension-forms\.js\?v=0\.4\.22/);
...
assert.match(html,/pension-pages\.js\?v=0\.4\.22/);
...
assert.match(html,/pwa\.js\?v=0\.4\.26/);
assert.match(html,/qa-mode\.js\?v=0\.4\.26/);
assert.match(html,/core-visual-utils\.js\?v=0\.4\.26/);
