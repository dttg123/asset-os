...
assert.match(html,/pension-assets\.js\?v=0\.4\.8/);
assert.match(html,/pension-forms\.js\?v=0\.4\.8/);
assert.match(html,/source-archive\.js\?v=0\.4\.8/);
assert.match(html,/css-integrated\.css\?v=0\.4\.8/);
assert.match(html,/pwa\.js\?v=0\.4\.8/);
