...
assert.match(html,/css-pension\.css\?v=0\.4\.20/);
assert.match(html,/css-shared-common\.css\?v=0\.4\.12/);
assert.match(html,/isa-summary\.js\?v=0\.4\.15/);
assert.match(html,/pension-pages\.js\?v=0\.4\.20/);
