...
test('v0.6.17 final views and export assets are shipped in the PWA shell',()=>{
 ...
 assert.match(html,/v=0\.6\.17-r2/);
 assert.match(html,/pwa\.js\?v=0\.6\.17-r2/);
 assert.match(html,/boot\.js\?v=0\.6\.17-r2/);
 assert.match(worker,/asset-os-v0\.6\.17-r2/);
 assert.match(worker,/v=0\.6\.17-r2/);
 assert.match(pwa,/service-worker\.js\?v=0\.6\.17-r2/);
