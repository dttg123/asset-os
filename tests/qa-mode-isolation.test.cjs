...
assert.equal(run('QA_MODE'),true);assert.equal(run('APP_VERSION'),'v0.6.0');assert.equal(run('KEY'),'asset-os-qa-v0.5');assert.equal(run('localYmd()'),'2060-12-31');
...
assert.equal(run('state.system.qaDataset.version'),'v0.6.0');
