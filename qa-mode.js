...
function qaBuildThirtyFiveYearState(){
 ...
 next.integrated={...buildIntegratedSeed(),startedAt:'2026-01-01',ledger};next.financialProducts={items:financialItems,events:[{id:'qa-interest',productId:'qa-deposit',date:'2060-12-31',type:'interestObserved',amount:700000,label:'QA 이자',note:'가상 데이터'}]};next.financeSchedules={items:[{id:'qa-schedule-pension',name:'QA 연금저축 월 납입',kind:'investment',amount:500000,day:25,recurrence:'monthly',startDate:'2026-01-01',endDate:'',targetKind:'pension',targetAccountId:'pension-link',targetPensionAccountId:'qa-pension',active:true,source:'qa'},{id:'qa-schedule-irp',name:'QA IRP 월 납입',kind:'investment',amount:250000,day:25,recurrence:'monthly',startDate:'2026-01-01',endDate:'',targetKind:'irp',targetAccountId:'irp-link',targetPensionAccountId:'qa-irp',active:true,source:'qa'}]};
